...
<td width="50%" valign="top">
  <a href="actual/DH-ARQ-PLN-002_CURRENT-UPPER-FLOOR.svg"><img src="actual/DH-ARQ-PLN-002_CURRENT-UPPER-FLOOR.png" alt="Current Dream House upper-floor plan with duty-based walls and a rear rescue window beside a wall-mounted vertical foldout escape ladder" width="100%"></a>
  <br><strong>Upper-floor plan</strong>
  <br><sub>0.3-draft-27-P2 · <a href="conceptual_v0.3_b27_p2/DH-ARQ-PLN-002-R24_P2-COORDINATED.svg">versioned source</a></sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
<td width="50%" valign="top">
  <a href="actual/DH-ARQ-DET-006_CURRENT-PB-INTEGRATED-WORKSTATIONS.svg"><img src="actual/DH-ARQ-DET-006_CURRENT-PB-INTEGRATED-WORKSTATIONS.png" alt="Dream House Side A shared two-person workstation with three suspended cabinets and unified modular window schematic detail" width="100%"></a>
  <br><strong>PB Side A shared two-person workstation</strong>
  <br><sub>0.3-draft-35-PB · <a href="conceptual_v0.3_b35_pb/DH-ARQ-DET-006-R02_SIDE-A-SHARED-WORKSTATION.svg">versioned source</a></sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
| `architecture-upper-floor` | Upper-floor plan | [SVG](actual/DH-ARQ-PLN-002_CURRENT-UPPER-FLOOR.svg) · [PNG](actual/DH-ARQ-PLN-002_CURRENT-UPPER-FLOOR.png) | [0.3-draft-27-P2](conceptual_v0.3_b27_p2/DH-ARQ-PLN-002-R24_P2-COORDINATED.svg) | issued for D-082 supplementary rescue-window and foldout-ladder coordination; required egress, product, anchorage, transfer safety, local approval and cost remain open; not for construction |
...
| `architecture-side-a-elevation` | Side A façade | [SVG](actual/DH-ARQ-ELE-003_CURRENT-SIDE-A.svg) · [PNG](actual/DH-ARQ-ELE-003_CURRENT-SIDE-A.png) | [0.3-draft-35-PB](conceptual_v0.3_b35_pb/DH-ARQ-ELE-003-R09_SIDE-A-PERFORMANCE-FIRST-OPENING.svg) | issued for D-078 interior-led Side A opening coordination; header, stability, safe glass, seals, low-eave drainage, thermal performance and cost remain open; not for construction |
...
| `architecture-access-egress` | Upper-floor access and egress | [SVG](actual/DH-ARQ-DIA-001_CURRENT-ACCESS-EGRESS.svg) · [PNG](actual/DH-ARQ-DIA-001_CURRENT-ACCESS-EGRESS.png) | [0.3-draft-27-P2](conceptual_v0.3_b27_p2/DH-ARQ-DIA-001-R24_P2-ACCESS-EGRESS.svg) | issued for D-082 supplementary rescue coordination; required exits, fire approval and rear grade discharge remain open; not for construction |
| `architecture-owner-priorities` | Active coordination interfaces | [SVG](actual/DH-ARQ-DET-002_CURRENT-OWNER-PRIORITIES.svg) · [PNG](actual/DH-ARQ-DET-002_CURRENT-OWNER-PRIORITIES.png) | [0.3-draft-27-P2](conceptual_v0.3_b27_p2/DH-ARQ-DET-002-R24_OWNER-PRIORITIES.svg) | issued for D-082 supplementary rescue-window and foldout-ladder coordination; product, structure, fire approval, transfer safety and cost remain open; not for construction |
