# Integrated coordination evidence — v0.4-I03

- Scenario: `D058_P2_HALL_EDGE`
- Input hash: `ae5dffe100136c2e625e33245eed168dbc0455bec306d3829ffea73df88a0ce5`
- Overall status: **COORDINATION_OPEN**
- Checks: 49 PASS / 6 OPEN / 0 FAIL
...
- PB technical glazing: 41.76 m².
- P2 windows: 55.02 m².
- D-054 rooflights: 23.04 m² glass and 28.80 m curb.
- Suite component areas: M 66.28, H1 38.00, H2 37.74, G 29.41 m².
...
|---|---:|---|---:|---|
| P2-GROSS-FLOOR | 270.00 m2 | 07 | not calculable | no |
| P2-WINDOWS | 55.02 m2 | 13.01 | COP 5,257,000 | no |
| PB-TECHNICAL-GLAZING | 41.76 m2 | 12.01 | COP 16,236,800 | no |
| PROGRAM-AREA | 171.43 m2 | unmapped | not calculable | no |
| ROOFLIGHT-CURB | 28.80 m | unmapped | not calculable | no |
| ROOFLIGHT-GLAZING | 23.04 m2 | unmapped | not calculable | no |
