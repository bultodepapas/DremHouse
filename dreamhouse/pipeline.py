...
DEFAULT_OUTPUT = REPOSITORY_ROOT / "planos" / "integracion_v0.4_i04"
...
def _evidence_markdown(results: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            "# Integrated coordination evidence — v0.4-I04",
            "",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--scenario", default="D059_P2_REFINED_ENVELOPE")
