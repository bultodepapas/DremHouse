...
def transverse():
    x0,base,sc=170,575,42; w=18*sc; roof=base-7.5*sc; slab=base-3.8*sc
    return f'''<svg xmlns="http://www.w3.org/2000/svg" width="1120" height="720"><rect width="1120" height="720" fill="#fbfaf7"/><g font-family="Arial" fill="#20292e"><text x="75" y="48" font-size="25" font-weight="700">CORTE TRANSVERSAL B–B · BAJO P2</text><text x="75" y="75" font-size="13" fill="#566269">Luz transversal nominal 18,00 m · estructura todavía por seleccionar</text><line x1="{x0}" y1="{base}" x2="{x0+w}" y2="{base}" stroke="#172126" stroke-width="4"/><polyline points="{x0},{roof+5} {x0+w},{roof}" fill="none" stroke="#172126" stroke-width="5"/><line x1="{x0}" y1="{base}" x2="{x0}" y2="{roof+5}" stroke="#172126" stroke-width="4"/><line x1="{x0+w}" y1="{base}" x2="{x0+w}" y2="{roof}" stroke="#172126" stroke-width="4"/><rect x="{x0}" y="{slab}" width="{w}" height="8" fill="#8f6f5a"/><text x="{x0+w/2}" y="{slab-16}" text-anchor="middle" font-size="14">P2 PRIVADO · altura libre objetivo 3,00–3,15 m</text><text x="{x0+w/2}" y="{slab+58}" text-anchor="middle" font-size="14">PB BAJO P2 · altura libre objetivo 3,05–3,20 m</text><line x1="{x0}" y1="{base+45}" x2="{x0+w}" y2="{base+45}" stroke="#566269"/><text x="{x0+w/2}" y="{base+39}" text-anchor="middle" font-size="12">18,00 m · sin columnas interiores adoptadas</text><rect x="75" y="650" width="970" height="48" fill="#fff3dc" stroke="#b95336"/><text x="95" y="680" font-size="17" font-weight="700" fill="#8e3825">NO APTO PARA CONSTRUIR · canto, apoyos, estabilidad y cimentación pendientes</text></g></svg>'''
