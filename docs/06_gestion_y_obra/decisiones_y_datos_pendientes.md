...
- Norte, topografía, vistas, viento, lluvia, drenaje y ruido.
- Norma escrita: uso, ocupación, altura, retiros y accesos.
- Servicios: energía disponible, agua, saneamiento, datos.
- Acceso de camión/izaje y logística.
- Campo RC: dirección, longitud útil, obstáculos y relación con vecinos.
- Lado de car bay vs. RC y posición de eventos de vidrio.
- Plataforma frontal, estacionamiento y acceso posterior.

## Antes de cerrar v0.3

- Áreas netas y espesores.
- Ejes/apoyos estructurales y estrategia de estabilidad.
- Escalera y egreso.
- Lift/vehículo a escala.
- Banco RC/avión/impresoras a escala.
...
- Matriz normativa cerrada.
- Diseños y revisiones firmados.
- Especificaciones y presupuesto coordinados.
- Equipos de compra temprana seleccionados.
...
- Licencia y permisos vigentes.
- Documentos IFC emitidos y lista maestra.
- Plan de calidad, inspección, ensayos, seguridad y ambiente.
- Submittals críticos aprobados.
- Línea base de costo/plazo y flujo de cambios.
- Responsables profesionales y de campo nombrados.
