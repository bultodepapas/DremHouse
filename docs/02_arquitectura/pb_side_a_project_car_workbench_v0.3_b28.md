...
**Status:** retained D-072 wall/lift predecessor; bench start coordinates superseded by
D-073/PB b29 and module/height/operating-strip geometry superseded by D-079/PB b36;
historical coordination evidence; not for construction
...
| Predecessor graphic bench/lift gap | 0.12 m | superseded by D-079's 0.10 m graphic test; neither is operating clearance |
...
the lift through the bench. It does not prove operation: the predecessor 0.12 m is deliberately recorded
...
explicit `OPEN` gate. D-079/PB b36 is the current modular and operating-strip test.
