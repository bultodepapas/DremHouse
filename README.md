<p align="center">
  <img src=".github/assets/dream-house-cover.svg" alt="Dream House en Boyacá: expediente vivo de una nave industrial residencial de 18 por 36 metros" width="100%">
</p>
...
<p align="center">
  <a href="https://github.com/bultodepapas/DremHouse/actions/workflows/showcase.yml"><img src="https://github.com/bultodepapas/DremHouse/actions/workflows/showcase.yml/badge.svg" alt="Estado de la presentación automática"></a>
</p>
...
<td width="50%" valign="top">
  <a href="planos/conceptual_v0.3_b05_pb/DH-ARQ-PLN-001-R04_PB-DETALLADA.svg"><img src="planos/conceptual_v0.3_b05_pb/DH-ARQ-PLN-001-R04_PB-DETALLADA.svg" alt="Lámina técnica de la planta baja detallada de Dream House" width="100%"></a>
  <br><sub><strong>Arquitectura · PB</strong> · 0.3-borrador-05-PB</sub>
  <br><strong>La nave como un solo recinto</strong>
</td>
<td width="50%" valign="top">
  <a href="planos/conceptual_v0.3_b06_p2/DH-ARQ-PLN-002-R05_P2-DETALLADA.svg"><img src="planos/conceptual_v0.3_b06_p2/DH-ARQ-PLN-002-R05_P2-DETALLADA.svg" alt="Lámina técnica del segundo piso detallado de Dream House" width="100%"></a>
...
<tr>
<td width="50%" valign="top">
  <a href="planos/conceptual_v0.3_b07_cubierta/DH-ARQ-SEC-002-R06_TRANSVERSAL-CUBIERTA.svg"><img src="planos/conceptual_v0.3_b07_cubierta/DH-ARQ-SEC-002-R06_TRANSVERSAL-CUBIERTA.svg" alt="Corte transversal de la cubierta mono-pendiente de Dream House" width="100%"></a>
...
```mermaid
flowchart LR
    A[Fuentes y decisiones] --> B[Modelos JSON]
    B --> C[Generadores Python]
    C --> D[Validaciones]
    C --> E[Láminas SVG]
    D --> F[Manifiestos trazables]
    E --> F
