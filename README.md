...
<!-- showcase:begin -->
<p align="center">
  <sub><strong>22</strong> current SVG/PNG pairs · <strong>107</strong> preserved versioned sheets · <strong>63</strong> documents · <strong>56</strong> decisions · <strong>6</strong> open conflicts</sub>
</p>
...
<td width="50%" valign="top">
  ...
  <br><sub><strong>Architecture · upper floor</strong> · 0.3-draft-21-P2</sub>
  <br><strong>Upper-floor plan</strong>
  <br><sub><a href="planos/conceptual_v0.3_b21_p2/DH-ARQ-PLN-002-R18_P2-COORDINATED.svg">Versioned source</a> · scalable current SVG above · PNG fallback in <code>planos/actual/</code></sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
  <a href="planos/actual/DH-ARQ-PLN-CUB-001_CURRENT-ROOF.svg"><img src="planos/actual/DH-ARQ-PLN-CUB-001_CURRENT-ROOF.svg" alt="Current Dream House roof and rooflight schematic plan" width="100%"></a>
  <br><sub><strong>Architecture · roof</strong> · 0.4-I01-ROOFLIGHTS</sub>
  <br><strong>Roof and rooflight plan</strong>
  <br><sub><a href="planos/integracion_v0.4_i01/rooflights/DH-ARQ-PLN-CUB-001-R11_D054-HALF-CENTRES.svg">Versioned source</a> · scalable current SVG above · PNG fallback in <code>planos/actual/</code></sub>
</td>
<td width="50%" valign="top">
  <a href="planos/actual/DH-ARQ-SEC-002_CURRENT-TRANSVERSE.svg"><img src="planos/actual/DH-ARQ-SEC-002_CURRENT-TRANSVERSE.svg" alt="Current Dream House mono-pitch transverse roof schematic section" width="100%"></a>
  ...
  <br><sub><a href="planos/conceptual_v0.3_b07_cubierta/DH-ARQ-SEC-002-R06_TRANSVERSAL-CUBIERTA.svg">Versioned source</a> · scalable current SVG above · PNG fallback in <code>planos/actual/</code></sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
  <a href="planos/actual/DH-ARQ-ELE-001_CURRENT-FRONT.svg"><img src="planos/actual/DH-ARQ-ELE-001_CURRENT-FRONT.svg" alt="Current Dream House front façade schematic elevation" width="100%"></a>
...
<td width="50%" valign="top">
  ...
  <br><sub><strong>Architecture · acoustic partition</strong> · 0.3-draft-21-P2</sub>
  <br><strong>P2-W01 · 250 mm acoustic wall</strong>
  <br><sub><a href="planos/conceptual_v0.3_b21_p2/DH-ARQ-DET-003-R18_P2-ACOUSTIC-PARTITION.svg">Versioned source</a> · scalable current SVG above · PNG fallback in <code>planos/actual/</code></sub>
</td>
<td width="50%" valign="top">
  ...
  <br><sub><strong>Architecture · open family balcony</strong> · 0.3-draft-21-P2</sub>
  <br><strong>P2-W04R · open balcony / retained suite edge</strong>
  <br><sub><a href="planos/conceptual_v0.3_b21_p2/DH-ARQ-DET-004-R18_P2-HALL-EDGE.svg">Versioned source</a> · scalable current SVG above · PNG fallback in <code>planos/actual/</code></sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
  ...
  <br><sub><strong>Architecture · refined P2 envelope</strong> · 0.3-draft-21-P2</sub>
  <br><strong>P2-W05 · double-frame exterior wall</strong>
  <br><sub><a href="planos/conceptual_v0.3_b21_p2/DH-ARQ-DET-005-R18_P2-EXTERIOR-WALL.svg">Versioned source</a> · scalable current SVG above · PNG fallback in <code>planos/actual/</code></sub>
</td>
<td width="50%" valign="top">
...
<td width="50%" valign="top">
  ...
  <br><sub><a href="planos/estructura/DH-EST-E1-002_CONTINUIDAD-VERTICAL-ESCALERA.svg">Versioned source</a> · scalable current SVG above · PNG fallback in <code>planos/actual/</code></sub>
</td>
</tr>
</table>
...
The partial upper floor brings together four acoustically enclosed suites, wellness spaces,
and a shared family centre that opens as an internal balcony toward the great hall. Its
residential side remains refined: corrugated metal stays outside, while double-frame
exterior walls conceal steel and services behind smooth, quiet interior finishes.
